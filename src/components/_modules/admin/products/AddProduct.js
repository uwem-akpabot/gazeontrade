...
const AddProduct = (props) => {
  ...
  const [subcategorylist, setSubcategorylist] = useState([]); // populate subcategory dropdown list
  ...
  const submitProduct = (e) => {
    handleSubmit(
      e,
      "/api/add-product",      // endpoint
      productInput,            // form state
      setProduct,              // reset function
      picture,                 // files
      setError,                // errors
  ...
  useEffect(() => {
    document.title = `Add Product - ${props.company}`;
  }, []);
                  ...
                  <div className="card-body">
                    ...
                    <FormComponent
                      fields={[
                        ...
                        { name: "product", label: "Product", type: "text", required: true, placeholder: "Enter product name" },
